...
export default function Button({
  ...
  const styles =
    variant === "primary"
      ? "bg-gradient-to-r from-cyan to-blue text-on-accent shadow-[0_0_0_1px_rgba(245,158,11,0.4)] hover:shadow-[0_0_30px_-4px_rgba(245,158,11,0.6)] hover:-translate-y-0.5"
